 ...
 */
struct lh_entry *json_get_keyword_entry(const struct lh_table *entry,
					const char *key);
 ...
 */
int json_validate_instance(struct json_object *jso, struct json_object *schema);
